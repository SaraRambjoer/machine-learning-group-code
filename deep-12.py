...
model01.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.1-sigmoid.csv"), logCallback01sigmoid])
...
model001.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.01-sigmoid.csv"), logCallback001sigmoid])
...
model0001.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.001-sigmoid.csv"), logCallback0001sigmoid])
...
model00001.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.0001-sigmoid.csv"), logCallback00001sigmoid])
...
model000001.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.00001-sigmoid.csv"), logCallback000001sigmoid])
...
model01leaky.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.1-leakyrelu.csv"), logCallback01leakyrelu])
...
model001leaky.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.01-leakyrelu.csv"), logCallback001leakyrelu])
...
model0001leaky.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.001-leakyrelu.csv"), logCallback0001leakyrelu])
...
model00001leaky.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.0001-leakyrelu.csv"), logCallback00001leakyrelu])
...
model000001leaky.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.00001-leakyrelu.csv"), logCallback000001leakyrelu])
