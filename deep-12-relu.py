...
model01.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.1-relu.csv"), logCallback01relu])
...
model001.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.01-relu.csv"), logCallback001relu])
...
model0001.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.001-relu.csv"), logCallback0001relu])
...
model00001.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.0001-relu.csv"), logCallback00001relu])
...
model000001.fit(x, encoded_Y, verbose=0, epochs=5000, batch_size=5, callbacks=[tf.keras.callbacks.CSVLogger("Logs/deep12-0.00001-relu.csv"), logCallback000001relu])
